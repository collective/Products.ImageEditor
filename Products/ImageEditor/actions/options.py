...
class IDropShadowOptions(Interface):
    ...
    background_color = schema.TextLine(
        title=_(u"label_dropshadow_background_color_title",
            default=u"Background color"),
    ...
    shadow_color = schema.TextLine(
        title=_(u"label_dropshadow_shadow_color_title",
            default=u"Shadow Color"),
...
class ISaveAsOptions(Interface):
    ...
    title = schema.TextLine(
        ...
        description=_(u"label_description_title_save_as",
            default=u"Title of the content type that is "
                    u"also used to generate its id."),
        required=True
    )
