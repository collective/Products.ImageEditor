...
setup(name='Products.ImageEditor',
      version='1.2',
      description="A product that adds an editor tab to ATImage and News Item "
                  "so you can rotate, flip, blur, compress, contrast, brightness, "
                  "sharpen, add drop shadows, crop, resize an image.",
      ...
      keywords='plone image rotate flip blur compress contrast brightness '
